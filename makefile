...
run_all: $(addprefix run_programa, $(seq_1_12)) $(addprefix run_programa, $(seq_14_25)) $(addprefix run_programa, $(seq_30_34)) $(addprefix run_programa, $(seq_38_38))
